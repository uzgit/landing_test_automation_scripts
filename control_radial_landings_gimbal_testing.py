...
landing_pad_camera_pose_position_x = 0
landing_pad_camera_pose_position_y = 0
landing_pad_camera_pose_position_z = 0
landing_pad_camera_pose_rotation_x = 0
landing_pad_camera_pose_rotation_y = 0
landing_pad_camera_pose_rotation_z = 0
landing_pad_camera_pose_rotation_w = 0

apriltag_detected = False
landing_pad_apriltag_global_pose_position_x = 0
landing_pad_apriltag_global_pose_position_y = 0
landing_pad_apriltag_global_pose_position_z = 0
landing_pad_apriltag_global_pose_rotation_x = 0
landing_pad_apriltag_global_pose_rotation_y = 0
landing_pad_apriltag_global_pose_rotation_z = 0
landing_pad_apriltag_global_pose_rotation_w = 0

whycon_detected = False
landing_pad_whycon_global_pose_position_x = 0
landing_pad_whycon_global_pose_position_y = 0
landing_pad_whycon_global_pose_position_z = 0
landing_pad_whycon_global_pose_rotation_x = 0
landing_pad_whycon_global_pose_rotation_y = 0
landing_pad_whycon_global_pose_rotation_z = 0
landing_pad_whycon_global_pose_rotation_w = 0
...
def gimbal_x_position_callback(data):

    global gimbal_x_position
    gimbal_x_position = data.data

def gimbal_y_position_callback(data):

    global gimbal_y_position
    gimbal_y_position = data.data

def landing_pad_camera_pose_callback(data):

    global landing_pad_detected

    global landing_pad_camera_pose_position_x
    global landing_pad_camera_pose_position_y
    global landing_pad_camera_pose_position_z

    global landing_pad_camera_pose_rotation_x
    global landing_pad_camera_pose_rotation_y
    global landing_pad_camera_pose_rotation_z
    global landing_pad_camera_pose_rotation_w

    landing_pad_camera_pose_position_x = data.pose.position.x
    landing_pad_camera_pose_position_y = data.pose.position.y
    landing_pad_camera_pose_position_z = data.pose.position.z

    landing_pad_camera_pose_rotation_x = data.pose.orientation.x
    landing_pad_camera_pose_rotation_y = data.pose.orientation.y
    landing_pad_camera_pose_rotation_z = data.pose.orientation.z
    landing_pad_camera_pose_rotation_w = data.pose.orientation.w

    landing_pad_detected = True

def landing_pad_apriltag_global_pose_callback(data):

    global apriltag_detected

    global landing_pad_apriltag_global_pose_position_x
    global landing_pad_apriltag_global_pose_position_y
    global landing_pad_apriltag_global_pose_position_z

    global landing_pad_apriltag_global_pose_rotation_x
    global landing_pad_apriltag_global_pose_rotation_y
    global landing_pad_apriltag_global_pose_rotation_z
    global landing_pad_apriltag_global_pose_rotation_w

    landing_pad_apriltag_global_pose_position_x = data.pose.position.x
    landing_pad_apriltag_global_pose_position_y = data.pose.position.y
    landing_pad_apriltag_global_pose_position_z = data.pose.position.z

    landing_pad_apriltag_global_pose_rotation_x = data.pose.orientation.x
    landing_pad_apriltag_global_pose_rotation_y = data.pose.orientation.y
    landing_pad_apriltag_global_pose_rotation_z = data.pose.orientation.z
    landing_pad_apriltag_global_pose_rotation_w = data.pose.orientation.w

    apriltag_detected = True

def landing_pad_whycon_global_pose_callback(data):

    global whycon_detected

    global landing_pad_whycon_global_pose_position_x
    global landing_pad_whycon_global_pose_position_y
    global landing_pad_whycon_global_pose_position_z

    global landing_pad_whycon_global_pose_rotation_x
    global landing_pad_whycon_global_pose_rotation_y
    global landing_pad_whycon_global_pose_rotation_z
    global landing_pad_whycon_global_pose_rotation_w

    landing_pad_whycon_global_pose_position_x = data.pose.position.x
    landing_pad_whycon_global_pose_position_y = data.pose.position.y
    landing_pad_whycon_global_pose_position_z = data.pose.position.z

    landing_pad_whycon_global_pose_rotation_x = data.pose.orientation.x
    landing_pad_whycon_global_pose_rotation_y = data.pose.orientation.y
    landing_pad_whycon_global_pose_rotation_z = data.pose.orientation.z
    landing_pad_whycon_global_pose_rotation_w = data.pose.orientation.w
...
def set_landing_pad_velocity(x_velocity):
    command = "rostopic pub --once /landing_pad/cmd_vel geometry_msgs/Twist '{linear: { x: %0.3f, y: 0, z: 0}}'" % x_velocity
    print(command)
    os.system(command)
...
column_names = ['time', 'iris_position_x', 'iris_position_y', 'iris_position_z', 'iris_linear_velocity_x', 'iris_linear_velocity_y', 'iris_linear_velocity_z', 'landing_pad_position_x', 'landing_pad_position_y', 'landing_pad_position_z', 'landing_pad_linear_velocity_x', 'landing_pad_linear_velocity_y', 'landing_pad_linear_velocity_z', 'landing_phase', 'plane_displacement', 'energy_consumed', 'latitude', 'longitude', 'altitude', 'landing_pad_relative_x', 'landing_pad_relative_y', 'landing_pad_relative_z', 'landing_pad_camera_pose_position_x', 'landing_pad_camera_pose_position_y', 'landing_pad_camera_pose_position_z', 'landing_pad_camera_pose_rotation_x', 'landing_pad_camera_pose_rotation_y', 'landing_pad_camera_pose_rotation_z', 'landing_pad_camera_pose_rotation_w', 'landing_pad_apriltag_global_pose_position_x', 'landing_pad_apriltag_global_pose_position_y', 'landing_pad_apriltag_global_pose_position_z', 'landing_pad_apriltag_global_pose_rotation_x', 'landing_pad_apriltag_global_pose_rotation_y', 'landing_pad_apriltag_global_pose_rotation_z', 'landing_pad_apriltag_global_pose_rotation_w', 'landing_pad_whycon_global_pose_position_x', 'landing_pad_whycon_global_pose_position_y', 'landing_pad_whycon_global_pose_position_z', 'landing_pad_whycon_global_pose_rotation_x', 'landing_pad_whycon_global_pose_rotation_y', 'landing_pad_whycon_global_pose_rotation_z', 'landing_pad_whycon_global_pose_rotation_w', 'landing_pad_detected', 'apriltag_detected', 'whycon_detected', 'gimbal_x_position', 'gimbal_y_position']
...
rospy.Subscriber("/landing_pad/camera_pose", PoseStamped, landing_pad_camera_pose_callback)
rospy.Subscriber("/landing_pad/apriltag_global_pose_stamped", PoseStamped, landing_pad_apriltag_global_pose_callback)
rospy.Subscriber("/landing_pad/whycon_global_pose_stamped", PoseStamped, landing_pad_whycon_global_pose_callback)
rospy.Subscriber("/gimbal/x/position", Float64, gimbal_x_position_callback)
rospy.Subscriber("/gimbal/y/position", Float64, gimbal_y_position_callback)
...
def radial_landing_run(theta, radius, up_position):
    ...
    dataframe.to_csv("/home/joshua/Documents/gimbal_and_pose_estimation_testing/theta_%0.3f.csv" % theta)
